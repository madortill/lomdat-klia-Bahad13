...
import AnnexationPage from './components/AnnexationPage.vue';
...
export default {
  ...
  data() {
    return {
      // מערך סדר העמודים - עמוד הפתיחה הוא הראשון
      pageOrder: [
        "OpenPage",
         "PageTwo",
         "Importance",
...
<style>
/* הגדרת הפונטים נשארת כאן ללא שינוי */
@font-face {
...
@font-face {
  ...
  src: url('./assets/fonts/Karantina-Light.ttf');
}
@font-face {
