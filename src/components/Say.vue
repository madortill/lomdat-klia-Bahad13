<template>
    ...
    <div class="speech-bubble-s">
      <h3>   אמרת נאשם</h3>
      <p >     אמרת נאשם נגבה מעריק / משתמט בעזרת ריאיון שנבצע עימו על פי השאלות שכתובות בטופס גביית האמרה.</p>
      <p > <strong>   אמרה זו היא ראייה משפטית שמשמשת את הפרקליטות הצבאית בתיק של החייל ויכולה לשמש לטובתו / כנגדו במשפט.</strong></p>
...
/* ==========================================================================
   נקודת השבירה: ברגע שהמסך קטן ממחשב (מתחת ל-1024px - כולל טאבלטים ומובייל)
   ========================================================================== */
   @media (max-width: 1388px) {
  /* הופך את המבנה לאנכי וממרכז את האלמנטים */
  .soldier-layout {
    display: flex;
    flex-direction: column; 
    align-items: center;
    justify-content: center;
    left: 0;        /* מאפס מיקומי דסקטופ */
    bottom: 0;      /* מאפס מיקומי דסקטופ */
    width: 90vw; 
  ...
  .speech-bubble-s {
    ...
    top: 0;             
    left: 0;            
    width: 100%;        /* מנצלת את רוב רוחב המסך הקיים */
    max-width: none;
    padding: 25px 30px; 
    border-radius: 30px;
  }

  /* החייל יורד מתחת לבועה ומקבל את הרווח הרספונסיבי המבוקש */
  .soldier {
    position: relative;
    top: 0;        
    right: 0;      
  ...
  /* התאמת גודל תמונת החייל למסכים קטנים יותר */
  .s-img {
    width: 60vw; 
    height: auto;
  }
